...
$LANG->includeLLFile('EXT:rk_exportdoc/cm1/locallang.xml');
...
class tx_rkexportdoc_cm1 extends t3lib_SCbase {
	var $pageinfo;
	var $o_treeview;
	var $o_doc;
	var $a_treeIds = array();
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rk_exportdoc/cm1/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rk_exportdoc/cm1/index.php']);
}
...
// Make instance:
$SOBE = t3lib_div::makeInstance('tx_rkexportdoc_cm1');
$SOBE->init();
