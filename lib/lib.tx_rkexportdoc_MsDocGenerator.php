...
class clsMsDocGenerator{
	...
	/**
	 * public void addHeader(string $content, string $header = 'h1')
	 * @param $content: content of the paragraph
	 * #param $header: header name the element
	 */
	function addHeader($content, $header = 'h1'){
		$this->documentBuffer .= "<".$header.">".($content == '' ? '<o:'.$header.'></o:'.$header.'>' : $content)."</".$header.">\n";
	}//end addHeader()
	 ...
	 * @param $debug: boolean if debug is set
	 */
